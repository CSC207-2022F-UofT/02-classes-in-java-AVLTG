...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Overrides the name method Silly
     * Two strings as taken by the constructor as arguments
     *
     * @param firstString the string that will appear at the first part of the Silly instance's name
     * @param secondString the string that will appear after the first part of the Silly instance's name
     */
